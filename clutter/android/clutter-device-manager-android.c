...
clutter_device_manager_android_constructed (GObject *object)
{
  ...
  _clutter_input_device_set_stage (priv->core_pointer, CLUTTER_STAGE (stage));
  ...
  _clutter_input_device_set_stage (priv->core_keyboard, CLUTTER_STAGE (stage));
...
void
_clutter_events_android_init (ClutterBackend *backend)
{
  CLUTTER_NOTE (EVENT, "Initializing android device manager");
...
void
_clutter_events_android_uninit (ClutterBackend *backend)
{
